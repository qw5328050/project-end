<template>
  ...
  >
    ...
    >
      ...
      <el-table-column label="供应商名称" prop="subContractorName" />
...
<script>
import { subcontractorsList } from "@/api/materialsSiteManagement/abarbeitung";
export default {
  name: "IndexDialog",
  props: {
    visible: {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      subcontractorsList(this.form).then((res) => {
