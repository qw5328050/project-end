  ...
  <table class="table table-bordered" style="page-break-after: always;">
    <tbody>
      ...
      <tr class="text-c header_col">
        <td rowspan="2" colspan="8" style="font-size: 24px">一般材料结算单</td>
      ...
      <tr class="text-c">
        ...
        <td colspan="15">{{ printData.orderNo || '' }}</td>
      </tr>
      <tr class="text-c">
      ...
      <template v-if="printData.type === 2">
        <tr
          v-for="(item, index) in printData.generalItemVoList"
          :key="index"
          class="text-c"
        >
