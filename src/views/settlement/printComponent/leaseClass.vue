  ...
  <table class="table table-bordered">
    <tbody>
      ...
      <tr class="text-c">
        ...
        <td colspan="8">{{ printData.projectName || '' }}</td>
        <td colspan="2">日期</td>
        <td colspan="8">{{ printData.settlementDate || '' }}</td>
      ...
      <tr class="text-c">
        ...
        <td colspan="9">{{ printData.contractCode || '' }}</td>
      </tr>
      <tr class="text-c">
      ...
      <template v-if="printData.type === 6">
        <tr
          v-for="(item, index) in printData.rentalItemVoList"
          :key="index"
          class="text-c"
        >
      ...
      <tr class="text-c">
        ...
        <td colspan="1">人民币大写:</td>
        <td colspan="9">
          {{ printData.settlementAmtTaxWords || '' }}
        </td>
      </tr>
      <tr class="text-c">
