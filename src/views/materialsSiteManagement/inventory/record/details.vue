    ...
    <div class="app-container">
      <el-card class="box-card" style="box-shadow: none">
        ...
        >
          ...
          <el-table-column prop="taxIncludeUnitPrice" label="含税单价(元)" v-if="form.contractSettlementType!=2"/>
          <el-table-column prop="taxReduceUnitPrice" label="降税单价(元)" v-if="form.contractSettlementType!=2"/>
