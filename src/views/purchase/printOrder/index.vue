          ...
          <div id="tablesBom" ref="tablesBom" class="ref_content">
            ...
            >
              ...
              >
                <tr class="text-c">
                  <td rowspan="3">
                    <svg-icon icon-class="table-logo" style="font-size: 55px" />
                  </td>
                  <td colspan="6" style="font-size: 25px; padding: 2%">
                    中国建筑项目管理表格
                  </td>
                </tr>
                <tr class="text-c">
                ...
                <tr class="text-c">
                  <td colspan="2">CSCEC8BNF-MM-B10109</td>
                </tr>
                <tr class="text-c">
                  <td>项目名称及编码</td>
                  <td colspan="6">{{ item.projName }} - {{ item.projCode }}</td>
                </tr>
                <tr class="text-c">
                  <td>供应商名称</td>
                ...
                <tr class="text-c">
                  <td>联系人</td>
                  <td colspan="3">{{ item.contacts }}</td>
                  <td>联系电话</td>
                  <td colspan="2">{{ item.contactPhone }}</td>
                </tr>
                <tr class="text-c">
                  <td>序号</td>
                  <td>物资名称</td>
                ...
                <tr
                  ...
                  ) in item.orderItemStampListVOS"
                  v-if="
                    item.orderItemStampListVOS &&
                      item.orderItemStampListVOS !== null
                  "
                  class="text-c"
                >
                  <td>{{ materialIndex + 1 }}</td>
                  <td>{{ material.name }}</td>
                  <td>{{ material.planSpecification }}</td>
                  <td>{{ material.unit }}</td>
                  <td>{{ material.num }}</td>
                ...
                <tr class="text-c">
                  <td colspan="2">物资工程师制表</td>
                  <td colspan="2">
                    {{ item.issuingUserName }} {{ item.issuingDate }}
                  </td>
                  <td>项目经理审批</td>
                  <td colspan="2">
                    {{ item.approvalUserName }} {{ item.approvalTime }}
                  </td>
                </tr>
              </table>
            </div>
