<template>
  <div class="details-container">
    <div id="details-nav">
      <h4>
        <span>退货单编号：{{ form.deliveryNo }}</span>
      </h4>
    </div>
    ...
    <Panel title="需用物资列表">
      <!-- 表格 -->
      <el-table :data="form.returnItemList" style="width: 100%">
...
<script>
import { supplierQueryReturnOrChangeDetail } from '@/api/supplier/ship/return'
const basicColumns = [
