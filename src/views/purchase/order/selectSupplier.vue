        ...
        <el-row :gutter="20">
          <el-col :xl="20" :lg="18" :md="16" :xs="16" :sm="16">
            <el-row :gutter="20">
              ...
              <!--                  <el-select-->
              <!--                    v-model="preOrderParam.purchaseStatus"-->
              <!--                    placeholder="请选择"-->
              <!--                    style="width: 100%"-->
              <!--                    clearable-->
              <!--                  >-->
              ...
              <!--              </el-col>-->
              <!--              <el-col :xl="6" :lg="8" :xs="12" :sm="12" :md="12">-->
              <!--                <el-form-item label="计划提交人员:" prop="submitPlanUser">-->
              <!--                  <el-select-->
              <!--                    v-model="preOrderParam.submitPlanUser"-->
              <!--                    placeholder="请选择"-->
              <!--                    style="width: 100%"-->
              <!--                    clearable-->
              <!--                  >-->
...
export default {
  name: 'OrderIndex',
  components: { indexDialog, printOrder, ApprovalProgress, ApproveDetail },
  computed: {
