<template>
  <div class="pageWrap">
    ...
    />
    <div class="mt20" style="margin-left:67px" @click="refuseTask"><el-button size="small ">驳回</el-button>
      <el-button size="small" type="primary" @click="permissTask">同意</el-button>  </div>
  </div>
</template>
