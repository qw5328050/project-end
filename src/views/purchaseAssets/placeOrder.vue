        ...
        <el-card class="pm">
          ...
          >
            ...
            <el-row :gutter="20">
              ...
              <el-col style="padding-left: 5px" :xl="7" :lg="8" :xs="12" :sm="12" :md="12">
              ...
              <el-col style="padding-left: 0px" :xl="7" :lg="8" :xs="12" :sm="12" :md="12">
    ...
    <div v-if="!submitSuccess" class="footer">
      <div class="select_box">
        ...
        <div class="action_buttons">
          ...
          <el-button type="primary" :loading="submitLoadingBtn" @click="submitOrderDetail(2)">
...
import { placeOrder, placeOrderItemsCheck } from '@/api/purchase/normalOrder'
    ...
    submitOrderDetail(status) {
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          // 提交前验证
          placeOrderItemsCheck(this.form).then(res => {
            if (this.isApproveShow && status === 2) {
              this.isApproveShow = false
              return
            } else if (!this.isApproveShow && status === 2) {
            ...
            // 如果选的是提交并且审批人信息为空
            if (status === 2 && (!this.approver || this.approver === null || this.approver.length === 0)) {
              this.$message.warning('请选择审批人信息')
              return
            }
            if (status === 2) {
