      ...
      <div class="scroll">
        <div v-loading="printLoading" class="print_content">
          <div id="tablesBom" ref="tablesBom" class="ref_content">
            ...
            >
              <table
                v-if="item.planType === 1 || item.planType === 4"
              ...
              >
                <tbody>
                  ...
                  <tr class="text-c header_col">
                    ...
                    >
                      {{ getDictionaryLabel(item.planType, 'planType') }}
                    </td>
                    <td>表格编号</td>
                  </tr>
                  <tr class="text-c header_col">
                    <td>{{ item.printCode }}</td>
                  </tr>
                  <tr class="text-c" style="border-top: 2px solid #202020">
                    <td colspan="12">
                      <div class="project">
                        <div class="name">
                          项目名称及编号:{{ item.projectName }}-{{
                            item.projectCode
                          }}
                        </div>
                        <div class="code">编号:{{ item.planCode }}</div>
                      </div>
                    </td>
                  </tr>
                  <slot name="content" :row="item" :list="item.materialList" />
                  <tr class="text-c">
                    <td colspan="2">
                      <div class="text_wid">商务工程师制表</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">{{ item.tabulation }}</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">商务经理审核</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">{{ item.audit }}</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">项目经理审批</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">{{ item.approval }}</div>
                    </td>
                  </tr>
                  <tr class="text-c">
                    <td colspan="2">
                    ...
                    <td colspan="2">
                      <div class="text_wid">{{ item.tabulationTime }}</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">日期</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">{{ item.auditTime }}</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">日期</div>
                    </td>
                    <td colspan="2">
                      <div class="text_wid">{{ item.approvalTime }}</div>
                    </td>
                  </tr>
                </tbody>
              </table>
              <table
                v-if="item.planType === 2"
                class="table table-bordered table"
              >
                <tbody>
                  <tr class="text-c">
                    <td :colspan="Math.ceil(item.columnTotal / 10)" rowspan="3">
                      <img src="@/assets/table-log.png" style="widht: 40px">
                    </td>
                    <td
                      :colspan="
                        item.columnTotal - Math.ceil(item.columnTotal / 10)
                      "
                      style="
                        font-size: 32px;
                        font-family: FZL2JW--GB1-0, FZL2JW--GB1;
                  ...
                  <tr class="text-c header_col">
                    <td
                      rowspan="2"
                      :colspan="
                        item.columnTotal - 2 * Math.ceil(item.columnTotal / 10)
                      "
                      style="font-size: 24px; width: 70%"
                    >
                      {{ getDictionaryLabel(item.planType, 'planType') }}
                    </td>
                    <td :colspan="Math.ceil(item.columnTotal / 10)">
                      表格编号
                    </td>
                  </tr>
                  <tr class="text-c header_col">
                  ...
                  <slot name="content" :row="item" :list="item.newList" />
                  <tr class="text-c">
                    <td :colspan="Math.floor(item.columnTotal / 6)">
                      <div class="text_wid">商务工程师制表</div>
                    </td>
                    <td :colspan="Math.floor(item.columnTotal / 6)">
                      <div class="text_wid">{{ item.tabulation }}</div>
                    ...
                    <td
                      :colspan="
                        item.columnTotal - Math.floor(item.columnTotal / 6) * 5
                      "
                    >
                      <div class="text_wid">{{ item.approval }}</div>
                    </td>
              ...
              >
                <tbody>
                  ...
                  <tr
                    :colspan="Math.ceil(item.columnTotal / 10)"
                    class="text-c header_col"
                  >
                    <td>{{ item.printCode }}</td>
                  </tr>
                  <tr class="text-c" style="border-top: 2px solid #202020">
