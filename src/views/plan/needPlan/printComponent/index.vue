              ...
              >
                <tbody>
                  ...
                  <tr class="text-c header_col">
                    ...
                    >
                      {{ getDictLabel(item.needPlanType) }}计划表
                    </td>
                    <td>表格编号</td>
                  </tr>
                  <tr class="text-c header_col">
                  ...
                  <tr class="text-c" style="border-top: 2px solid #202020">
                    <td colspan="8">
                      <div class="project">
                        ...
                        <div class="code">编号:{{ item.needPlanCode }}</div>
                      </div>
                    </td>
                  </tr>
                  <slot name="content" :list="item.planMaterials" :row="item" />
                  <tr class="text-c">
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">编制</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.compile }}</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">生产经理</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.production }}</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">商务经理</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.business }}</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">项目经理</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.manager }}</div>
                    </td>
                  </tr>
                  <tr class="text-c">
                    <td colspan="1" style="width: 12.5%">
                    ...
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.compileTime }}</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">日期</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.productionTime }}</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">日期</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.businessTime }}</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">日期</div>
                    </td>
                    <td colspan="1" style="width: 12.5%">
                      <div class="text_wid">{{ item.managerTime }}</div>
                    </td>
                  </tr>
                </tbody>
              </table>
              <table v-else class="table table-bordered table">
                <tbody>
                  <tr class="text-c">
                    <td rowspan="3">
                      <img src="@/assets/table-log.png" style="widht: 40px">
                  ...
                  <slot name="content" :list="item.planConcretes" :row="item" />
                  <tr class="text-c">
                    <td colspan="3" style="width: 37.5%">
                      <div class="text_wid">方量计算式</div>
                    </td>
                    <td colspan="5" style="width: 62.5%">
                      <div class="text_wid">{{ item.volumeCalWay }}</div>
                    </td>
                  </tr>
                  <tr class="text-c">
                    <td colspan="2" style="width: 25%">
                      <div class="text_wid">编制人</div>
                    </td>
                    <td colspan="2" style="width: 25%">
                      <div class="text_wid">{{ item.compile }}</div>
                    </td>
