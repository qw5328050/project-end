  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 2, label: `废旧物资类型`, visible: true },
        { key: 3, label: `废旧物资名称`, visible: false },
        { key: 4, label: `处理日期`, visible: false },
        { key: 5, label: `申请表编号`, visible: true },
        { key: 6, label: `暂估数量`, visible: true },
        { key: 7, label: `市场价格`, visible: true },
        { key: 8, label: `金额`, visible: true },
        { key: 9, label: `报告批复时间`, visible: true },
        { key: 10, label: `是否招标处理`, visible: true },
        { key: 11, label: `处理数量`, visible: false },
        { key: 12, label: `累计处理数量`, visible: false },
        { key: 13, label: `处理单价`, visible: true },
        { key: 14, label: `处理金额`, visible: true },
        { key: 15, label: `财务收款收据编号`, visible: true },
        { key: 16, label: `收款人`, visible: false },
        { key: 17, label: `经办人`, visible: true },
        { key: 18, label: `模板累计消耗量`, visible: true },
        { key: 19, label: `累计完成模板接触面搭建面积`, visible: true },
        { key: 20, label: `模板周转次数`, visible: true },
